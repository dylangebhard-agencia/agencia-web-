...
```
╭─ squirrel revive — narrative & energy
│  [agent 1 output]
╰─

╭─ squirrel revive — decisions & reasoning
│  [agent 2 output]
╰─

╭─ squirrel revive — quotes & moments
│  [agent 3 output]
╰─

╭─ squirrel revive — technical substance
│  [agent 4 output]
╰─

╭─ squirrel revive — open threads
│  [agent 5 output]
╰─
```
